        ...
        <div className="container">
          <MotionWrapper>
            <p className="home-clients-label">
              <i className="fa-solid fa-circle-check"></i>
              Trusted by 500+ businesses across India, Australia &amp; the US
            </p>
          </MotionWrapper>
        </div>
        ...
        <div className="container">
          <MotionWrapper>
            <div className="section-title text-center section-title-center">
              ...
              <p>A proven four-step process that has delivered first-page results for 500+ businesses. No black-box tactics — just clear strategy, executed well.</p>
            </div>
          </MotionWrapper>
