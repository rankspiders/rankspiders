...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Free Keyword Density Checker | Rank Spiders', description: 'Find the most used keywords, 2-word and 3-word phrases on any webpage. Check keyword density %, placement in title/H1/H2, and avoid over-optimisation.', type: 'website', siteName: 'Rank Spiders' },
  alternates: { canonical: 'https://www.rankspiders.com/tools/keyword-density' },
};
