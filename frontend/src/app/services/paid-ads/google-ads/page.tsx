  ...
  const faqs = [
    {
      ...
      answer: "Google Ads puts your brand in front of people actively searching for what you offerâ€”capturing high-intent demand at the moment of decision. This search intent makes Google Ads consistently the highest-converting paid channel for lead generation and direct sales."
    },
    {
      id: 2,
      question: "2. What Google Ads campaign types do you manage?",
      answer: "We manage Search, Display, Shopping, Performance Max, Video (YouTube), and Demand Gen campaignsâ€”selecting and combining the right types for your specific objectives, whether that's lead generation, e-commerce sales, brand awareness, or app installs."
    },
    {
      id: 3,
    ...
    },
    {
      ...
      answer: "We focus on improving Quality Scores through tightly themed ad groups, highly relevant ad copy, and landing page alignment. Higher Quality Scores mean lower CPCs and better ad positionsâ€”more visibility for less spend."
    },
    {
      id: 5,
      question: "5. Do you manage Google Shopping for e-commerce?",
      answer: "Yes. We manage Google Shopping and Performance Max campaigns for e-commerceâ€”including product feed optimisation, bidding strategy management, and Shopping campaign segmentation to maximise ROAS across your catalogue."
    }
  ];
            ...
            <div className="col-lg-8">
              <div className="service-single-content">
                ...
                <div className="service-entry">
                  <p>Google Ads is the world's most powerful intent-based advertising platform. We manage Google Ads campaigns that capture high-intent search demand, maximise quality scores, and turn clicks into customersâ€”with every rupee tracked and optimised for maximum return.</p>
                  <div className="service-strategy-box">
                    <h2 data--delay="0.4s">Google Ads That <span>Capture Ready Buyers</span></h2>
                    <p data--delay="0.6s">Search, Shopping, Display, and YouTubeâ€”managed with precision to maximise your ROAS.</p>
                    <ul data--delay="0.8s">
            ...
            <div className="col-lg-6">
              <div className="our-belief-content">
                <div className="section-title section-title-center">
                  <h3>Our Belief</h3>
                  <h2 data--delay="0.2s" data-cursor="-opaque">Intent + Precision = <span>Profitable Growth</span></h2>
                  <p data--delay="0.4s">Google Ads rewards precision. We build campaigns that are specific enough to be profitable from the first month and scalable enough to grow with your ambition.</p>
                </div>
