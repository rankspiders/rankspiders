  ...
  const faqs = [
    {
      ...
      answer: "Our service covers the full stack â€” profile optimisation, content strategy, creative production (reels, carousels, stories), hashtag strategy, community management, and monthly performance reporting. You can choose organic only, paid only, or a combined package."
    },
    {
      id: 2,
      question: "2. How many posts will you create per month?",
      answer: "Our standard plans include 12â€“20 posts per month depending on your package. This includes a mix of feed posts, reels, and stories. Every post is planned in advance and approved by you before publishing."
    },
    {
      id: 3,
    ...
    },
    {
      ...
      answer: "Organic follower growth depends on your niche, current account size, and content quality. Most clients see consistent, targeted growth within 60â€“90 days. We focus on quality followers â€” people who are genuinely interested in your service."
    },
    {
      id: 5,
            ...
            <div className="col-lg-8">
              <div className="service-single-content">
                ...
                <div className="service-entry">
                  <p>Instagram is the highest-engagement social platform for most consumer and B2C brands. Our Instagram marketing service turns your profile from a passive page into an active lead-generation engine â€” through content that stops the scroll and ads that convert.</p>

                  <div className="service-strategy-box">
                    <h2 data--delay="0.4s">Instagram Growth That <span>Translates Into Revenue</span></h2>
                    <p data--delay="0.6s">We build Instagram strategies designed around one goal â€” turning followers into enquiries and enquiries into customers.</p>
                    ...
                    <div className="service-strategy-body " data--delay="1s">
                      <div className="strategy-body-item">
                        ...
                        <p>Every reel, post, and story is designed for your specific audience â€” with hooks, captions, and visuals built to maximise reach and saves.</p>
                      </div>
                      <div className="strategy-body-item">
                  ...
                  <div className="service-growth-box">
                    <h2>What We Do Month-to-Month</h2>
                    <p data--delay="0.2s">Consistency wins on Instagram. We handle every aspect of your monthly content operation so your profile stays active, professional, and on-brand without requiring hours of your time.</p>
                    ...
                    <div className="service-growth-body">
                      ...
                      <div className="service-growth-item-list " data--delay="0.6s">
                        ...
                        <div className="service-growth-item">
                          ...
                          <p>Every month we deliver content, engage with your community, and send you a report showing reach, engagement, follower growth, and â€” most importantly â€” how many enquiries came through Instagram.</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="col-lg-6">
              <div className="our-belief-content">
                <div className="section-title section-title-center">
                  <h3>Our Belief</h3>
                  <h2 data--delay="0.2s" data-cursor="-opaque">Instagram Should <span>Bring You Clients, Not Just Followers</span></h2>
                  <p data--delay="0.4s">Follower counts mean nothing if they don't translate into enquiries. Every decision we make â€” from the hook on a reel to the call-to-action in a story â€” is designed to move the right people closer to contacting your business.</p>
                </div>
